"""
Kişisel Enflasyon Web Interface
Flask-based web UI for personal inflation tracking
"""
    ...
    <script>
        async function loadDashboard() {
            try {
                ...
                const statsResponse = await fetch('/api/inflation/stats');
                ...
                const productsResponse = await fetch('/api/inflation/products?limit=10');
        ...
        document.getElementById('addProductForm').addEventListener('submit', async (e) => {
            ...
            try {
                const response = await fetch('/api/inflation/add-product', {
                    method: 'POST',
                    headers: {
...
@app.route('/api/inflation/products')
...
@app.route('/api/inflation/add-product', methods=['POST'])
def api_add_product():
...
@app.route('/api/inflation/search')
...
def start_web_server(host='0.0.0.0', port=5002):
